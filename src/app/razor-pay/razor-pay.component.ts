...
export class RazorPayComponent implements OnInit {
  ...
  public initPay() {
	...
	openrazor(id) {
		let options = {
			key: 'rzp_live_eH6oSFaPlWJcF8', // Enter the Key ID generated from the Dashboard
			amount: this.amt.totalAmount*100, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
			currency: 'INR',
			name: 'Krishna',
